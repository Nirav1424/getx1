...
class AppColors {
  ...
  static final String GREENTEXT = 'green';
  static final String REDTEXT = 'red';
  static final String fetchRedColorCode = "#f44336";
  static final String fetchGreenColorCode = "#4caf50";
}
